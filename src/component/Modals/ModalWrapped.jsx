...
// actions 
import { getLocations, getBrands, getZones, getCashDesks, getBlurs, addWidget } from '../../actions/widgetActions'

import { selects } from '../../utils/modalSelects'
import moment from 'moment'

class ModalWrapped extends Component {
    ...
    handleSubmit = () => {
        ...
        formData.append("children", send)



        this.props.addWidget(send)
...
export default connect(mapStateToProps, { getBrands, getLocations, getZones, getCashDesks, getBlurs, addWidget })(ModalWrapped)
